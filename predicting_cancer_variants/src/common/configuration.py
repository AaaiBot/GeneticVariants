...
# allow the singleton to get reset so that unit tests can exercise Configuration with different filenames
def reset_singleton():
    global instances
    instances = {}
...
class Configuration:
    ...
    @property
    def database_table_name_study(self):
        configuration = self.__get_configuration()
        return configuration['common']['tables_names']['study']

    @property
    def database_table_name_cancer(self):
        configuration = self.__get_configuration()
        return configuration['common']['tables_names']['cancer']

    @property
    def database_table_name_molecular(self):
        configuration = self.__get_configuration()
        return configuration['common']['tables_names']['molecular']

    @property
    def database_table_name_mutation(self):
        configuration = self.__get_configuration()
        return configuration['common']['tables_names']['mutation']

    @property
    def database_table_name_gene(self):
        configuration = self.__get_configuration()
        return configuration['common']['tables_names']['gene']
    ...
    def minimum_samples_per_study(self):
        configuration = self.__get_configuration()
        return configuration['downloader']['minimum_samples_per_study']
