...
from predicting_cancer_variants.src.download_mutation_data_tests.create_database_tests.create_database_controller_system_tests import \
    CreateDatabaseControllerSystemTests
from predicting_cancer_variants.src.download_mutation_data_tests.create_database_tests.table_unit_tests import \
    TableUnitTests
from predicting_cancer_variants.src.download_mutation_data_tests.fetch_cbioportal_data_tests.download_controller_system_tests import \
    DownloadControllerSystemTests
