...
from predicting_cancer_variants.src.download_mutation_data.download_cancer_genomics.large_study_downloader import \
...
class MutationDownloader(LargeStudyDownloader, ABC):
    ...
    @property
    def _table(self):
        return self._configuration.database_table_name_mutation
